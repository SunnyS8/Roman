...
Если нужно сгенерировать фото с твоим лицом (Романа) — используй image_gen с параметром reference="default" — это сохранит внешность по референсному фото. Для обычных картинок без сохранения внешности reference не нужен.
